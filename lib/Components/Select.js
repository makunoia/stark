...
const Select = ({
  ...
  const [selectedOption, setSelectedOption] = (0, _react.useState)(multiple ? [] : "");
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_react2.Listbox, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_react2.Listbox.Label, {
        htmlFor: `${id}`,
    ...
    }), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_react2.Listbox.Button, {
      id: id,
      ...
      onFocus: handleFocus,
      onBlur: handleBlur,
      children: [Boolean(selectedOption) && selectedOption.length > 0 ? multiple ? selectedOption.length <= 2 ? options.filter(option => selectedOption.includes(option.value)).map(option => option.label).join(", ") : options.filter(option => selectedOption.includes(option.value)).slice(0, 2).map(option => option.label).join(", ") + `, and ${selectedOption.length - 2} more` : options.find(option => option.value === selectedOption).label : placeholder, /*#__PURE__*/(0, _jsxRuntime.jsx)("i", {
        className: "ri-arrow-down-s-line font-bold text-[16px]"
      })]
    }), multiple && selectedOption.length > 0 && /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      className: "flex flex-wrap gap-4px mt-2",
      children: options.filter(option => selectedOption.includes(option.value)).map(option => /*#__PURE__*/(0, _jsxRuntime.jsx)(_Badge.default, {
        label: option.label,
        primary: true,
        outline: true,
        dismissible: true,
        onDismiss: () => setSelectedOption(selectedOption.filter(v => v !== option.value))
      }, option.id))
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_react2.Listbox.Options, {
        className: "absolute top-[75px] transition-all z-10 p-8px max-h-[200px] overflow-y-auto scroll-smooth flex flex-col gap-4px bg-white rounded-4px border border-outline-default w-full",
        children: options.map(option => /*#__PURE__*/(0, _jsxRuntime.jsxs)(_react2.Listbox.Option, {
          value: option.value,
          ...
          className: ({
            active,
            selected
          }) => (0, _clsx.default)("cursor-pointer px-8px py-8px rounded-4px text-body relative outline-none", {
          ...
          children: [option.label, (multiple ? selectedOption.includes(option.value) : selectedOption === option.value) && /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
