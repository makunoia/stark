...
var Combobox = function Combobox(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react2.Combobox, {
    ...
    className: "".concat(label ? "top-[65px]" : "top-[45px]", " absolute transition-all z-10 p-8px max-h-[200px] overflow-y-auto scroll-smooth flex flex-col gap-4px bg-white rounded-4px border border-outline-default w-full focus:outline-none")
    ...
    return /*#__PURE__*/_react.default.createElement(_react2.Combobox.Option, {
      ...
      className: function className(_ref2) {
        ...
        return (0, _clsx.default)("cursor-pointer px-8px py-8px rounded-4px text-body relative", {
    ...
    className: "px-8px py-8px text-body text-gray-800"
  }, "No results"))), (helpText || error) && /*#__PURE__*/_react.default.createElement("p", {
