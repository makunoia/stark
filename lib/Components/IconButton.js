...
var IconButton = function IconButton(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("button", {
    ...
    className: (0, _clsx.default)("inline-flex gap-4px items-center justify-center font-semibold text-body whitespace-nowrap ".concat(state !== "disabled" ? color === "default" ? textClasses["default"] : type === "solid" ? textClasses["white"] : textClasses[color] : textClasses["disabled"], " ").concat(loading && "opacity-20 cursor-wait"))
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "text-[16px] flex justify-center items-center h-[16px] w-[16px] relative"
  }, icon ? /*#__PURE__*/_react.default.createElement("div", {
    className: "absolute "
  }, /*#__PURE__*/_react.default.cloneElement(icon)) : /*#__PURE__*/_react.default.createElement("div", {
    className: "absolute "
