...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("button", {
    ...
    className: (0, _clsx.default)("relative group justify-center items-center flex font-default transition-colors duration-200 ease-in-out h-fit ".concat(typeClasses[buttonType], " ").concat(fullWidth ? "w-full" : "w-fit", " ").concat(buttonType !== "text" ? sizeClasses[buttonSize] : "", " ").concat(state === "disabled" //check if the button is disabled
