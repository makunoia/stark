...
const Button = ({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("button", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("label", {
      className: (0, _clsx.default)(`inline-flex gap-4px items-center justify-center text-body whitespace-nowrap ${state !== "disabled" ? color === "default" ? textClasses["default"] : type === "solid" ? textClasses["white"] : textClasses[color] : textClasses["disabled"]} ${loading && "opacity-20 cursor-wait"}`),
