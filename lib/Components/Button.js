...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("button", {
    ...
    className: (0, _clsx.default)("absolute cursor-wait top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-8px h-[18px] w-[18px] text-[18px] font-bold", state !== "disabled" ? buttonVariant === "default" //is the button default?
