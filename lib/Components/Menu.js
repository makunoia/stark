...
var Menu = function Menu(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react2.Menu, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "bg-white flex flex-col pb-8px mt-8px rounded-4px h-fit w-fit focus:outline-none shadow-lg absolute right-[0px] origin-top-right border border-outline-default"
    ...
    return /*#__PURE__*/_react.default.createElement(_react.Fragment, {
      ...
      className: "text-gray-800 font-semibold tracking-wide text-[11px] uppercase mb-[6px] mt-16px px-16px"
      ...
      return (
        ...
        _react.default.createElement(_react2.Menu.Item, {
          ...
          return /*#__PURE__*/_react.default.createElement("a", {
            href: link.href,
            className: "whitespace-nowrap px-16px pr-24px py-8px w-full text-body font-normal flex flex-row gap-4px items-center ".concat(active ? " bg-gray-100/70 text-black" : "bg-white text-copy-caption")
          }, link.icon && /*#__PURE__*/_react.default.createElement("span", {
            className: "mr-4px text-copy-caption text-[16px]"
          }, link.icon), link.label);
        })
      );
    }), groupIndex < links.length - 1 && /*#__PURE__*/_react.default.createElement("div", {
      className: "border-t border-outline-default mt-12px"
    }));
  })))));
};
var _default = Menu;
