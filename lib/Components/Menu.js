...
var Menu = function Menu(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react2.Menu, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "bg-white flex flex-col mt-8px rounded-4px h-fit min-w-[200px] focus:outline-none shadow-lg absolute left-[0px] origin-top-right"
    ...
    return /*#__PURE__*/_react.default.createElement(_react.Fragment, {
      ...
      className: "text-black font-bold tracking-wider text-[11px] uppercase px-16px py-4px"
