    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_react2.Menu.Button, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_react2.Menu.Items, {
          ...
          children: links.map((group, groupIndex) => /*#__PURE__*/(0, _jsxRuntime.jsxs)(_react.Fragment, {
            ...
            (0, _jsxRuntime.jsx)(_react2.Menu.Item, {
              ...
              children: ({
                ...
                href: link.href,
                className: `whitespace-nowrap px-12px pr-24px py-12px rounded-4px w-full text-body flex flex-row gap-4px items-center ${active ? "bg-blue-500 bg-primary-muted text-black" : "bg-white text-black"}`,
                children: [link.icon && /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
                  className: "mr-4px text-primary-base text-[18px]",
                  children: link.icon
                }), link.label]
              })
            }, link.href)), groupIndex < links.length - 1 && /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
