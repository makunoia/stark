...
var Checkbox = function Checkbox(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    htmlFor: id,
    className: "text-body font-medium select-none ".concat(disabled ? "text-copy-disabled cursor-not-allowed" : "text-copy-caption cursor-pointer", " ").concat(checked ? "text-primary-base" : "")
