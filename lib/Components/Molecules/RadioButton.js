...
var RadioButton = function RadioButton(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "absolute rounded-[100%] w-[10px] h-[10px] transform ".concat(checked ? "scale-100 bg-white" : "scale-0 bg-white", " transition-transform ease-in-out duration-200")
