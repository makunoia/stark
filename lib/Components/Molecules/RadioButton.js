...
var RadioButton = function RadioButton(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    htmlFor: id,
    className: "cursor-pointer relative flex items-center justify-center min-w-[20px] min-h-[20px] border-2 rounded-[100%] ".concat(checked ? "bg-primary-base border-primary-base" : "bg-white border-outline-default", " transition-colors ease-in-out duration-200 ").concat(helpText ? "mb-[18px]" : "")
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "absolute rounded-[100%] w-[8px] h-[8px] transform ".concat(checked ? "scale-100 bg-white shadow-md" : "scale-0 bg-white", " transition-transform ease-in-out duration-200")
