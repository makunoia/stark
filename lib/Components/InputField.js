...
var InputField = function InputField(_ref) {
  ...
  var inputField = /*#__PURE__*/_react.default.createElement("input", {
    ...
    value: inputValue,
    id: id,
    className: "input w-full h-full py-12px bg-transparent outline-none ".concat(disabled ? "cursor-not-allowed" : "", " ").concat(!leadingItem && "pl-12px")
  });
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    type: "button"
  }, labelAction.label)), type === "textarea" ? textArea : type === "richtext" ? richTextField :
  /*#__PURE__*/
