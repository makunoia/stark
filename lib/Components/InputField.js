...
var InputField = function InputField(_ref) {
  ...
  var inputField = /*#__PURE__*/_react.default.createElement("input", {
    ...
    value: inputValue,
    id: id,
    className: "input w-full h-full py-10px bg-transparent outline-none ".concat(disabled ? "cursor-not-allowed" : "", " ").concat(!leadingItem && "pl-12px")
  });
  ...
  }, showPassword ? /*#__PURE__*/_react.default.createElement(_RemixIcon.default, {
    name: "eye-line"
