...
function App() {
  const [selectedRadioValues, setSelectedRadioValues] = (0, _react.useState)(["radio-1"]);
  const [selectedCheckboxValues, setSelectedCheckboxValues] = (0, _react.useState)(["checkbox-1", "checkbox-2"]);
  const [switchToggled, setSwitchToggled] = (0, _react.useState)(false);
  const [checkTerms, setCheckTerms] = (0, _react.useState)(false);
  ...
  const [finishedComponents, setFinishedComponents] = (0, _react.useState)(["molecules", "buttons", "option", "switch", "inputfields", "indicator", "badge", "avatar", "select", "combobox", "menu", "richtext", "maskedinput"]);
